...
module Runner =
  ...
  let runSingle (validate:bool) (language:FormsGenTarget) (inputPath:string) (outputPath:string) (generatedPackage:string) (formName:string) (codegenConfigPath:string) =
      ...
      try
        ...
        try
              ...
              | FormsGenTarget.golang ->
                ...
                | Left generatedCode -> 
                  ...
                  try
                    ...
                    Left({| OutputPath=outputPath; GeneratedCode=generatedCode |})
                  with
                  | err -> 
          ...
          | Right (err,_) -> 
            Right err
          | _ -> 
            Right(Errors.Singleton $"Unexpected error: parsing produced no results.")
          with
          | err -> 
  ...
  let run (validate:bool) (language:FormsGenTarget) (inputPath:string) (outputPath:string) (generatedPackage:string) (formName:string) (codegenConfigPath:string) =
    let inputPaths = 
    ...
    for inputPath in inputPaths do
      match runSingle (validate:bool) (language:FormsGenTarget) (inputPath:string) (outputPath:string) (generatedPackage:string) (formName:string) (codegenConfigPath:string) with
      | Left res ->

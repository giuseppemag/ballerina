                ...
                let result =
                        ...
                        sum {
                            ...
                            | t ->
                                return!
                                    sum.Throw(
                                        sprintf
                                            "Error: unexpected case check on type %A when typechecking expression %A"
                                            t
                                            e
                                        |> Errors.Singleton
                                    )
                        ...
                        sum {
                            ...
                            | UnionType cases ->
                                ...
                                if Set.isProperSuperset handledCases expectedCases then
                                    return!
                                        sum.Throw(
                                            Errors.Singleton $"Error: too many handlers {handledCases - expectedCases}"
                                        )
                            ...
                            | t ->
                                return!
                                    sum.Throw(
                                        sprintf
                                            "Error: unexpected match-case on type %A when typechecking expression %A"
                                            t
                                            e
                                        |> Errors.Singleton
                                    )
                        ...
                        sum {
                            ...
                            | t ->
                                return!
                                    sum.Throw(
                                        sprintf
                                            "Error: unexpected lookup on type %A when typechecking expression %A"
                                            t
                                            e
                                        |> Errors.Singleton
                                    )
                    ...
                    | Expr.Binary(Or, e1, e2) ->
                        sum {
                            ...
                            match t1, t2 with
                            | PrimitiveType BoolType, PrimitiveType BoolType ->

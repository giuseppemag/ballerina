...
export const LoadedCollectionEntity = {
  Default: {
    fromEntity: <E>(e: CollectionEntity<E>): LoadedCollectionEntity<E> => ({
      value: AsyncState.Operations.hasValue(e.value.value.sync)
        ? e.value.value.sync.value
        : undefined,
      ...
      synchronizationErrors: [
        ...AsyncState.Operations.errors(e.value.sync),
        ...AsyncState.Operations.errors(e.value.value.sync),
      ],
      isRemoved: e.removed,

...
export const SingletonFormTemplate = <Entity, EnumKeys extends keyof Entity, InfiniteEnumKeys extends keyof Entity, CustomTypeFields>() => Template.Default<
  SingletonFormReadonlyContext<Entity, EnumKeys, InfiniteEnumKeys, CustomTypeFields> & SingletonFormWritableState<Entity, EnumKeys, InfiniteEnumKeys, CustomTypeFields>,
...
value = { props.context.entity[field] as Date } />
  ...
  props.context.entityDescriptor[field].render({
    value: props.context.entity[field] as any,
    onChange: newValue => {

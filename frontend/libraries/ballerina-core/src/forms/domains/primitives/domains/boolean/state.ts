...
export type BooleanView<Context extends FormLabel, ForeignMutationsExpected> = 
  View<
    Context & Value<boolean> & { commonFormState: CommonFormState } & { disabled:boolean }, 
...
export type MaybeBooleanView<Context extends FormLabel, ForeignMutationsExpected> = 
  View<
    Context & Value<boolean | undefined> & { commonFormState: CommonFormState } & { disabled:boolean }, 
    { commonFormState: CommonFormState }, 

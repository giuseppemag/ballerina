...
import { CollectionReference, EnumValue } from "../../../collection/domains/reference/state";
...
export const EnumForm = <Context extends FormLabel & BaseEnumContext<Element>, ForeignMutationsExpected, Element extends EnumValue>(

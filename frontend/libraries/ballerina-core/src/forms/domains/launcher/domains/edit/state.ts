...
import { ApiResponseChecker, AsyncState, BasicUpdater, CommonFormState, Debounced, DirtyStatus, FieldPredicateExpressions, ForeignMutationsInput, FormFieldPredicateEvaluation, Guid, id, ParsedType, PredicateValue, replaceWith, SimpleCallback, simpleUpdater, simpleUpdaterWithChildren, Sum, Synchronized, Template, unit, Unit, Updater, Value } from "../../../../../../main"
...
export type EditFormContext<E,FS> = {
  ...
  toApiParser: (entity:E, formstate: EditFormState<E,FS>, checkKeys: boolean) => ValueOrErrors<E, ApiErrors>,
  ...
  Updaters:{
    Core:{
      ...
      ...simpleUpdaterWithChildren<EditFormState<E,FS>>()({
          ...
          ...simpleUpdater<EditFormState<E,FS>["customFormState"]>()("configApiChecker"),
          ...
          ...simpleUpdater<EditFormState<E,FS>["customFormState"]>()("predicateEvaluations"),
      })("customFormState"),
...
export type EditFormForeignMutationsExpected<E,FS> = {
  apiHandlers?: {
    ...
    onConfigSuccess?: (_: EditFormWritableState<E, FS> & EditFormContext<E, FS> | undefined) => void;

...
export const RawFieldType = { 
  ...
  isUnion: <T>(_: RawFieldType<T>): _ is {fun: "Union", args: Array<{case: string, fields: object}>} => hasFun(_) && isGenericType(_.fun) && hasArgs(_) && _.fun == "Union" && _.args.length > 0 && _.args.every(__ => typeof __ == "object" && "case" in __ && "fields" in __),

  ...
  "forms": {
    ...
    "person": {
      ...
      "fields": {
        ...
        "dependants": {
          renderer: "defaultMap",
          keyRenderer: { renderer: "defaultString", visible: { "kind": "true" } },
          keyLabel: "name",
        ...
        "friendsByCategory": {
          ...
          keyLabel: "category",
          valueRenderer: { renderer: "defaultString", visible: { "kind": "true" } },
          valueLabel: "name",
          visible: { "kind": "true" },
        },
        ...
        "addresses": { renderer: "defaultList", elementLabel: "address", elementRenderer:"address", visible: { "kind": "true" } },

...
export const Child1 = {
  ...
  ForeignMutations: (
    _: ForeignMutationsInput<Child1ReadonlyContext, Child1WritableState>,
  ) => ({}),
};
...
export type Child1ForeignMutationsExposed = ReturnType<
  typeof Child1.ForeignMutations
>;
export type Child1View = View<
  Child1ReadonlyContext & Child1WritableState,
  Child1WritableState,

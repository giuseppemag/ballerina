...
const Value = {
  Default: {
    ...
    StringWithApproval: (value: string, approved: boolean): Value => ({
      kind: "stringWithApproval",
      value: { value, approved },
    }),
    Nested: (value: OrderedMap<FieldIdentifier, Value>): Value => ({
      kind: "nested",
      value,
    }),
  ...
  Operations: {
    TryFind:
      ...
      (value: Value): Sum<Unit, Value> =>
        pathToField.length == 0
          ? Sum.Default.right(value)
          : typeof pathToField[0] == "number" && value.kind == "table"
            ? Value.Operations.TryFind(pathToField.slice(1))(
                value.value[pathToField[0]],
              )
            : typeof pathToField[0] == "string" &&
                value.kind == "nested" &&
                value.value.has(pathToField[0])
              ? Value.Operations.TryFind(pathToField.slice(1))(
                  value.value.get(pathToField[0])!,
                )
...
type CardField =
  | { kind: "section"; card: CardConfig }
  | { kind: "field lookup"; pathToField: FieldPath; disabled?: true };
const CardField = {
  Default: {
    Section: (card: CardConfig): CardField => ({ kind: "section", card }),
    FieldLookup: (pathToField: FieldPath, disabled?: true): CardField => ({
      kind: "field lookup",
      pathToField,
      disabled,
    }),
...
const Card = {
  Default: (header: string, fields: Array<CardField>): CardConfig => ({
    header,
    fields,
  }),
};
...
const NumberRenderer = (props: {
  value: number;
  onNewValue: (edit: ValueEdit & { kind: "number" }) => void;
}): JSX.Element => (
  <>
    <h2>Number</h2>
    {props.value}
...
const StringRenderer = (props: {
  value: string;
  onNewValue: (edit: ValueEdit) => void;
}): JSX.Element => (
  <>
    <h2>String</h2>
    {props.value}
...
const StringWithApprovalRenderer = (props: {
  value: WithApproval<string>;
  onNewValue: (edit: ValueEdit) => void;
}): JSX.Element => (
  <>
...
const NestedRenderer = (props: {
  value: OrderedMap<FieldIdentifier, Value>;
  onNewValue: (edit: ValueEdit) => void;
}): JSX.Element => (
  <>
    <h2>Nested</h2>
      ...
      .map((value, fieldname) =>
        ValueRenderer({
          ...
          onNewValue: (edit) =>
            props.onNewValue({
              kind: "nested",
              value: [fieldname, edit] as [FieldIdentifier, ValueEdit],
            }),
        }),
      )
      .valueSeq()}
  ...
  <>
    ...
    {props.value.map((value, index) =>
      ValueRenderer({
        value,
        onNewValue: (edit) =>
          props.onNewValue({ kind: "table", value: [index, edit] }),
      }),
    )}
  </>
);
const ValueRenderer = (props: {
  ...
  props.value.kind == "number" ? (
    <NumberRenderer value={props.value.value} onNewValue={props.onNewValue} />
  ) : props.value.kind == "string" ? (
    <StringRenderer value={props.value.value} onNewValue={props.onNewValue} />
  ) : props.value.kind == "stringWithApproval" ? (
    <StringWithApprovalRenderer
      value={props.value.value}
      onNewValue={props.onNewValue}
    />
  ) : props.value.kind == "nested" ? (
    <NestedRenderer value={props.value.value} onNewValue={props.onNewValue} />
  ) : (
...
export const CardRenderer = (props: {
  ...
  entity: Value;
  onNewField: (edit: FieldEdit) => void;
}) => {
  return (
    <>
      ...
      <ul>
        {props.cardConfig.fields.map((fieldPath) => {
          if (fieldPath.kind == "field lookup") {
            const fieldValue = Value.Operations.TryFind(fieldPath.pathToField)(
              props.entity,
            );
            return fieldValue.kind == "l" ? (
              ...
              <>
                ...
                <ValueRenderer
                  ...
                  onNewValue={(valueEdit) =>
                    props.onNewField({
                      fieldPath: fieldPath.pathToField,
                      valueEdit,
                    })
                  }
                />
              ...
              {cardsConfigFromAPI.map((cardConfig) => (
                <td>
                  <CardRenderer
                    ...
                    onNewField={(fieldEdit) => alert(JSON.stringify(fieldEdit))}
                  />
                </td>
              ))}
            </tr>

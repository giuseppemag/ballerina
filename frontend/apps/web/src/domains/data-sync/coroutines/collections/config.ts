...
export const collectionsConfig = () => collectionSynchronizationContext<DataSyncReadonlyContext, Collections, CollectionMutations, WholeCollectionMutations, DataSyncWritableState>({
  addresses: {

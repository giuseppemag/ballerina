import { singletonSynchronizationContext, Synchronize, Value, Synchronized, Unit, PromiseRepo, unit, SynchronizeWithValueUpdater, AsyncState } from "ballerina-core";
...
export const singletonsConfig = () => singletonSynchronizationContext<DataSyncReadonlyContext, Singletons, SingletonMutations, DataSyncWritableState>({
  user: {
    entityName: "user",
    edit: _ => SynchronizeWithValueUpdater<Value<Synchronized<Unit, User>>, Unit>(_ => PromiseRepo.Default.mock(() => 
      [
        unit,

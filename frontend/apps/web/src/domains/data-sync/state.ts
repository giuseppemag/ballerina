...
export const DataSync = () => ({
  ...
  ForeignMutations: (
    ...
    const [
      SingletonLoaders,
      SingletonDirtyCheckers,
      SingletonDirtySetters,
      SingletonUpdaters,
      SingletonEntityConfigs,
      SingletonMutationArgumentComparators,
    ] = singletonsConfig();
    const [
      CollectionLoaders,
      ...
      CollectionUpdaters,
      CollectionEntityConfigs,
      CollectionEntitiesMutationArgumentComparators,
      WholeCollectionMutationArgumentComparators,
    ] = collectionsConfig();
...
export type DataSyncForeignMutationsExposed = ReturnType<
  typeof DataSync
>["ForeignMutations"];

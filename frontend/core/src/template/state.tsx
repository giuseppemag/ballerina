...
export type TemplateProps<context, state, foreignMutations> =
  { context: context, setState: BasicFun<BasicUpdater<state>, void>, foreignMutations: foreignMutations, children?:JSX.Element | JSX.Element[] }
...
export type Template<context, state, foreignMutations> =
  {
    ...
    mapView: (f: BasicFun<{ children?:JSX.Element | JSX.Element[] }, JSX.Element>) => Template<context, state, foreignMutations>,
...
export const createTemplate = <context, state, foreignMutations>(actual: TemplateRunner<context, state, foreignMutations>):
  ...
  result.mapView = function (this: Template<context, state, foreignMutations>, f: BasicFun<{ children?:JSX.Element | JSX.Element[] }, JSX.Element>) {
...
export const Template = {
  ...
  Operations: {
    MapView: <context, state, foreignMutations>(p: Template<context, state, foreignMutations>, Wrapper: BasicFun<{ children?:JSX.Element | JSX.Element[] }, JSX.Element>): Template<context, state, foreignMutations> =>

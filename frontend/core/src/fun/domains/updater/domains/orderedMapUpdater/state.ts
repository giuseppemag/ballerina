...
export type OrderedMapUpdater<Entity, Field extends keyof Entity> = Entity extends {
...
export const orderedMapUpdater = <Entity>() => <Field extends keyof Entity>(field: Field): OrderedMapUpdater<Entity, Field> => ({
  [field]: {
...
}) as OrderedMapUpdater<Entity, Field>;

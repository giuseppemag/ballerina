...
❌ \_generate* translation of models into ef and OpenAPI
❌ records
❌ unions
❌ with recursion
...
✅ coroutine runner extension. we currently have both _.ts and _.tsx you've mentioned that we will only have \*.ts
